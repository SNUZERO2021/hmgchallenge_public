...
class FrenetPath1D {
 public:
    ...
    int degree = -1;           // 4 or 5
    double c_decision_offset = 0;
    double c_decision_ratio = 1;
...
public:
    FrenetOptimalTrajectory& operator=(const FrenetOptimalTrajectory& o);
...
private:
    ...
    vector<vector<ConvexHull>> dynamic_obstacles;
    vector<ConvexHull> static_obstacles;
    vector<double> x, y;
