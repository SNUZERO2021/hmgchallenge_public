...
string net_path = "/home/snuzero/hmgchallenge_v4/ros/ros1_ws/src/vehicle_detection/custom.cfg";
...
class DataSubscriber{
    ...
    public:
        DataSubscriber(){
            ...
            tf::Quaternion q_1;
            tf::Vector3 v_1 = tf::Vector3(2.25, 0.5, 2.0);
            q_1.setRPY(0,0,90.0*M_PI/180.0);
            lidar_tf_1 = tf::Transform(q_1,v_1);

            tf::Quaternion q_2;
            tf::Vector3 v_2 = tf::Vector3(2.25, -0.5, 2.0);
            q_2.setRPY(0,0,0);
            ...
            homography_right = calc_homography(2.1,-0.7, 1.9, 0, 25.0, -100.0);
            homography_front = calc_homography(2.3, 0.0, 1.9, 0, -15.0, 0);
            homography_left = calc_homography(2.1, 0.7, 1.9, 0, 25.0, 100.0);
